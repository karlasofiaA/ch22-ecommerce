...
public class CustomerController {
	...
	@PreAuthorize("hasAnyRole('ROLE_ADMIN')") // Paso 9. Autorizar la solicitud solo para ADMIN
	@GetMapping //localhost:8080/api/customers
	public List<CustomerDto> getAllCustomers(){
		return customerService.getAllCustomerDto();		
	}
	
	@PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_USER')") // Paso 9. Autorizar la solicitud solo para ADMIN
